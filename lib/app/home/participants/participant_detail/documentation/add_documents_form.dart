...
class AddDocumentsForm extends StatefulWidget {
  ...
  final PersonalDocumentType participantDocument;
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              CustomTextBoldCenter(
                title: '${widget.participantDocument.title}', color: AppColors.primary900,),
              SizedBox(height: 20,),
  ...
  Future<void> _submit() async {
    ...
    if (_validateAndSaveForm() && filesList.length > 0) {
      ...
      DocumentationParticipant document = DocumentationParticipant(
        ...
        documentCategoryId: widget.participantDocument.documentCategoryId,
        documentSubCategoryId: widget.participantDocument.personalDocId,
      );
      try {
        final database = Provider.of<Database>(context, listen: false);
        filesList.forEach((file) async {
          await database.uploadPersonalDocument(widget.participantUser.userId!, file.name, file.data!, document);
        });
