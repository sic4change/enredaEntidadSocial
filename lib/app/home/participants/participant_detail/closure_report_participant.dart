            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    CustomTextBoldTitle(title: 'Informe de cierre de caso'.toUpperCase()),
                  ],
                ),
              ),
              ...
              StreamBuilder<ClosureReport>(
                  ...
                  builder: (context, snapshot) {
                    if(snapshot.hasData){
                      ...
                      return completeClosureForm(context, closureReportSaved, user);
                    }
                    else{
...
Widget completeClosureForm(BuildContext context, ClosureReport report, UserEnreda user){
  final database = Provider.of<Database>(context, listen: false);
  ...
  List<DropdownMenuItem<String>> _closureReasonsOptions = ['Por éxito de inserción', 'Por desvinculación de la usuaria', 'Por mudanza', 'Porque ha conseguido empleo por sus propios medios'].map<DropdownMenuItem<String>>((String value){
