...
class MyInitialReport extends StatefulWidget {
  const MyInitialReport({
    Key? key,
    required this.user,
...
class MyAppState extends State<MyInitialReport> with SingleTickerProviderStateMixin {
  ...
  Future<void> _init() async {
    ...
    _tabController = TabController(
      vsync: this,
      length: examplesInitialReport.length,
      initialIndex: _tab,
    );
  ...
  Future<void> _saveAsFile(
    ...
    final file = File('$appDocPath/myInitialReport.pdf');
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: examplesInitialReport.map((e) => CustomTextBold(title: e.name,)).toList(),
