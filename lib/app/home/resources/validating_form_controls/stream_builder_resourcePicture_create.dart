...
Widget streamBuilderDropdownResourcePictureCreate (BuildContext context, ResourcePicture? selectedResourcePicture, functionToWriteBackThings ) {
  ...
  return StreamBuilder<List<ResourcePicture>>(
      ...
      builder: (context, snapshotResourcePictures){
        ...
        return DropdownButtonFormField<ResourcePicture>(
          ...
          validator: (value) => selectedResourcePicture != null ? null : StringConst.FORM_COMPANY_ERROR,
