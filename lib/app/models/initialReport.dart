...
class InitialReport {
  InitialReport({
    ...
    this.orientation10,
    this.motiveClose,
    this.motiveCloseDetail,
    this.closeDate,

    //Reopening
    this.reopeningMotive,
  });
  ...
  final String? motiveClose;
  final String? motiveCloseDetail;
  final DateTime? closeDate;

  //Reopening
  final String? reopeningMotive;

  factory InitialReport.fromClosureReport(ClosureReport closure) {
    return InitialReport(
      userId: closure.userId,
      finished: false,
      subsidy: closure.subsidy,
      techPerson: closure.techPerson,
      techPersonName: closure.techPersonName,
      dniParticipant: closure.dniParticipant,
      orientation1: closure.orientation1,
      arriveDate: closure.arriveDate,
      receptionResources: closure.receptionResources,
      administrativeExternalResources: closure.administrativeExternalResources,
      adminState: closure.adminState,
      adminNoThrough: closure.adminNoThrough,
      adminDateAsk: closure.adminDateAsk,
      adminDateResolution: closure.adminDateResolution,
      adminDateConcession: closure.adminDateConcession,
      adminTemp: closure.adminTemp,
      adminResidenceWork: closure.adminResidenceWork,
      adminDateRenovation: closure.adminDateRenovation,
      adminResidenceType: closure.adminResidenceType,
      adminJuridicFigure: closure.adminJuridicFigure,
      adminOther: closure.adminOther,
      orientation2: closure.orientation2,
      expirationDate: closure.expirationDate,
      healthCard: closure.healthCard,
      medication: closure.medication,
      orientation2_1: closure.orientation2_1,
      rest: closure.rest,
      diagnosis: closure.diagnosis,
      treatment: closure.treatment,
      tracking: closure.tracking,
      orientation2_2: closure.orientation2_2,
      disabilityState: closure.disabilityState,
      referenceProfessionalDisability: closure.referenceProfessionalDisability,
      disabilityGrade: closure.disabilityGrade,
      granted: closure.granted,
      revisionDate: closure.revisionDate,
      disabilityType: closure.disabilityType,
      orientation2_3: closure.orientation2_3,
      dependenceState: closure.dependenceState,
      referenceProfessionalDependence: closure.referenceProfessionalDependence,
      dependenceGrade: closure.dependenceGrade,
      orientation2_4: closure.orientation2_4,
      externalDerivation: closure.externalDerivation,
      motive: closure.motive,
      orientation3: closure.orientation3,
      internalDerivationLegal: closure.internalDerivationLegal,
      internalDerivationDate: closure.internalDerivationDate,
      internalDerivationMotive: closure.internalDerivationMotive,
      externalDerivationLegal: closure.externalDerivationLegal,
      externalDerivationDate: closure.externalDerivationDate,
      externalDerivationMotive: closure.externalDerivationMotive,
      psychosocialDerivationLegal: closure.psychosocialDerivationLegal,
      psychosocialDerivationDate: closure.psychosocialDerivationDate,
      psychosocialDerivationMotive: closure.psychosocialDerivationMotive,
      legalRepresentation: closure.legalRepresentation,
      processingBag: closure.processingBag,
      processingBagDate: closure.processingBagDate,
      economicAmount: closure.economicAmount,
      orientation4: closure.orientation4,
      ownershipType: closure.ownershipType,
      location: closure.location,
      centerContact: closure.centerContact,
      hostingObservations: closure.hostingObservations,
      ownershipTypeOpen: closure.ownershipTypeOpen,
      homelessnessSituation: closure.homelessnessSituation,
      homelessnessSituationOpen: closure.homelessnessSituationOpen,
      livingUnit: closure.livingUnit,
      ownershipTypeConcrete: closure.ownershipTypeConcrete,
      orientation5: closure.orientation5,
      informationNetworks: closure.informationNetworks,
      institutionNetworks: closure.institutionNetworks,
      familyConciliation: closure.familyConciliation,
      orientation7: closure.orientation7,
      languages: closure.languages,
      orientation9: closure.orientation9,
      centerTSReference: closure.centerTSReference,
      subsidyBeneficiary: closure.subsidyBeneficiary,
      socialExclusionCertificate: closure.socialExclusionCertificate,
      subsidyName: closure.subsidyName,
      socialExclusionCertificateDate: closure.socialExclusionCertificateDate,
      socialExclusionCertificateObservations:
          closure.socialExclusionCertificateObservations,
      orientation12: closure.orientation12,
      vulnerabilityOptions: closure.vulnerabilityOptions,
      orientation13: closure.orientation13,
      orientation13_2: closure.orientation13_2,
      educationLevel: closure.educationLevel,
      tempLabor: closure.tempLabor,
      workingDayLabor: closure.workingDayLabor,
      competencies: closure.competencies,
      contextualization: closure.contextualization,
      connexion: closure.connexion,
      shortTerm: closure.shortTerm,
      mediumTerm: closure.mediumTerm,
      longTerm: closure.longTerm,
      orientation9_5: closure.orientation9_5,
      formations: closure.formations,
      formationBag: closure.formationBag,
      formationBagDate: closure.formationBagDate,
      formationBagMotive: closure.formationBagMotive,
      formationBagEconomic: closure.formationBagEconomic,
      jobObtaining: closure.jobObtaining,
      jobObtainDate: closure.jobObtainDate,
      jobFinishDate: closure.jobFinishDate,
      jobUpgrade: closure.jobUpgrade,
      upgradeMotive: closure.upgradeMotive,
      upgradeDate: closure.upgradeDate,
      orientation9_6: closure.orientation9_6,
      postLaborAccompaniment: closure.postLaborAccompaniment,
      postLaborAccompanimentMotive: closure.postLaborAccompanimentMotive,
      postLaborInitialDate: closure.postLaborInitialDate,
      postLaborFinalDate: closure.postLaborFinalDate,
      postLaborTotalDays: closure.postLaborTotalDays,
      jobMaintenance: closure.jobMaintenance,
      laborSituation: closure.laborSituation,
      homologation: closure.homologation,
      laborOtherConsiderations: closure.laborOtherConsiderations,
      
      orientation10: closure.orientation10,
      motiveClose: closure.motiveClose,
      motiveCloseDetail: closure.motiveCloseDetail,
      closeDate: closure.closeDate,
    );
  }
  factory InitialReport.fromMap(Map<String, dynamic> data, String documentId) {
    ...
    if (data['formations'] != null) {
      data['formations'].forEach((formation) {
        ...
        formations.add(FormationReport(
    ...
    return InitialReport(
      ...
      completedDate:
          data['completedDate'] != null ? data['completedDate'].toDate() : null,
      ...
      arriveDate:
          data['arriveDate'] != null ? data['arriveDate'].toDate() : null,
      ...
      adminDateAsk:
          data['adminDateAsk'] != null ? data['adminDateAsk'].toDate() : null,
      adminDateResolution: data['adminDateResolution'] != null
          ? data['adminDateResolution'].toDate()
          : null,
      adminDateConcession: data['adminDateConcession'] != null
          ? data['adminDateConcession'].toDate()
          : null,
      adminTemp: data['adminTemp'],
      adminResidenceWork: data['adminResidenceWork'],
      adminDateRenovation: data['adminDateRenovation'] != null
          ? data['adminDateRenovation'].toDate()
          : null,
      ...
      revisionDate:
          data['revisionDate'] != null ? data['revisionDate'].toDate() : null,
      ...
      internalDerivationDate: data['internalDerivationDate'] != null
          ? data['internalDerivationDate'].toDate()
          : null,
      internalDerivationMotive: data['internalDerivationMotive'],
      externalDerivationLegal: data['externalDerivationLegal'],
      externalDerivationDate: data['externalDerivationDate'] != null
          ? data['externalDerivationDate'].toDate()
          : null,
      externalDerivationMotive: data['externalDerivationMotive'],
      psychosocialDerivationLegal: data['psychosocialDerivationLegal'],
      psychosocialDerivationDate: data['psychosocialDerivationDate'] != null
          ? data['psychosocialDerivationDate'].toDate()
          : null,
      ...
      processingBagDate: data['processingBagDate'] != null
          ? data['processingBagDate'].toDate()
          : null,
      ...
      socialExclusionCertificateDate:
          data['socialExclusionCertificateDate'] != null
              ? data['socialExclusionCertificateDate'].toDate()
              : null,
      socialExclusionCertificateObservations:
          data['socialExclusionCertificateObservations'],
      ...
      formationBagDate: data['formationBagDate'] != null
          ? data['formationBagDate'].toDate()
          : null,
      formationBagMotive: data['formationBagMotive'],
      formationBagEconomic: data['formationBagEconomic'],
      jobObtaining: data['jobObtaining'],
      jobObtainDate:
          data['jobObtainDate'] != null ? data['jobObtainDate'].toDate() : null,
      jobFinishDate:
          data['jobFinishDate'] != null ? data['jobFinishDate'].toDate() : null,
      jobUpgrade: data['jobUpgrade'],
      upgradeMotive: data['upgradeMotive'],
      upgradeDate:
          data['upgradeDate'] != null ? data['upgradeDate'].toDate() : null,
      ...
      postLaborInitialDate: data['postLaborInitialDate'] != null
          ? data['postLaborInitialDate'].toDate()
          : null,
      postLaborFinalDate: data['postLaborFinalDate'] != null
          ? data['postLaborFinalDate'].toDate()
          : null,
      ...
      motiveClose: data['motiveClose'],
      motiveCloseDetail: data['motiveCloseDetail'],
      closeDate: data['closeDate'] != null ? data['closeDate'].toDate() : null,

      //Reopening
      reopeningMotive: data['reopeningMotive'],
    );
  }
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'languages':
          languages != null ? languages!.map((e) => e.toMap()).toList() : [],
      ...
      'formations':
          formations != null ? formations!.map((e) => e.toMap()).toList() : [],
      ...
      'motiveClose': motiveClose,
      'motiveCloseDetail': motiveCloseDetail,
      'closeDate': closeDate,

      //Reopening
      'reopeningMotive': reopeningMotive,
    };
  }
}
